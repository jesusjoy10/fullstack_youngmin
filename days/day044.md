...
- 클래스의 사용 
  ...
  - 인스턴스의 생성~소멸까지 개발자가 아닌 컨테이너가 하는 것
...
실습1)  spring1     [◎ 프로젝트명 : spring001]
  ...
  4.  E:\hyojung\6_spring\sts-bundle\sts-3.9.18.RELEASE
      > STS.exe
  5.  순수 스프링버젼 
    1. dynamic web project - spring001            // new -  dynamic web project  
...
1-2. 롬복 이용해서 @Data 설정 - 생성자, getters/setters, toString       // pom.xml 에 <dependencies> 복붙하기 - > 게터세터 안하고  @Data 넣기 
[com.pany.ex2] - [UserInfo] private Stirng name, private int age

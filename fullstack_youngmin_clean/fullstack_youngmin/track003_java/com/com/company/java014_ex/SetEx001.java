...
class UserInfo2{
	...
	@Override // alt+s  +  hash()and equals() 넣어주면 set 중북허용 없어짐
	...
	public static void main(String[] args) {
		...
		//Q5. 사용자들의 이름 입력받기 - 이름을 입력받으면 해댱하는 유저의 자료출력
		 ...
		 for (UserInfo2 user : sets) {
			 ...
			 else { System.out.println("검색 이름 없음");} break;
		 }		
		//Q6. 사용자들의 나이 평균처리
		 int totalAge = 0;
		 for (UserInfo2 user : sets) {
		 ...
		 double avgAge = (double) totalAge / sets.size();
		 System.out.println("사용자 평균 나이: " + avgAge);

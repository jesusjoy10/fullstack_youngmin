...
/*
 * /list.quest /view/quest_board/list.jsp /write.quest
 * /view/quest_board/write.jsp (글쓰기폼) /detail.quest /view/quest_board/detailjsp
 * (상세보기) /edit.quest /view/quest_board/edit.jsp (수정하기폼) /delete.quest
 * /view/quest_board/delete.jsp (삭제하기폼)
 */
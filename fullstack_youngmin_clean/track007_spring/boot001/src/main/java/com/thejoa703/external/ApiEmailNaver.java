...
public class ApiEmailNaver {
	...
	public void sendMail(String subject, String content, String email) {
		...
		String user= "dudals5292xn@naver.com"; // 네이버아이디@naver.com
		String password= "YEP84HRFTFCT"; //2단계 인증 비밀번호
		//2. 받는사람
		String to = email;
		...
		//3. 인증세션설정
	      ...
	      try {
	    	  message.setFrom(new InternetAddress(user)); //보내는사람 dudals5292xn@naver.com
	    	  ...
	    	  message.setContent("" 
	    			    ...
	    			    + "<p style='font-size:12px; color:#888; text-align:center;'>이 메일은 자동 발송된 안내 메일입니다.<br>문의: <a href='mailto:support@example.com' style='color:#005bac; text-decoration:none;'>dudals5292xn@naver.com</a></p>"
	    			    + "</div>"

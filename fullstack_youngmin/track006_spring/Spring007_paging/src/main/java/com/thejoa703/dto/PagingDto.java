...
public class PagingDto {
	...
	private  int  pagetotal;    //#3) 총페이지  256/10 = 26   25페이지 + 6글 = 26개  123/10= 13   13개  110/10=11
	...
	public PagingDto(int listtotal, int pstartno) {  // 전체페이지수 ,  시작번호   ( 이전 1,2,3,4,   다음)
		super();
		...
		this.bottomlist = 10;
		this.pstartno = (pstartno-1)*onepagelist + 1;   //  (1)1,10       (2)11,20   (3)21,30  (db에서 가져올번호)
		this.current  = pstartno;    //1,2,3

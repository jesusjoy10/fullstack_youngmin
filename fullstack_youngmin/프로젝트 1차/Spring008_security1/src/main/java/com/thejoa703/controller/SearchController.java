 ...
 * com.thejoa703.service.Sboard1Service;
 * 
 * @RestController //@Controller + @ResponseBody public class SearchController {
 * 
 * @Autowired Sboard1Service service;
 * 
 * @RequestMapping("/selectSearch") //@ResponseBody public String hi() { //처리하고
 * return "Hi"; //값줄게
 * 
 * }
 * 
 * // 이미지 업로드 board 성공 / 멤버에서 이미지 업로드 성공?
 * 
 * 
 * 
 * }

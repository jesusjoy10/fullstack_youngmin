...
public class MethodEx005 { 
	...
	public static String process_pass(float avg, int kor, int eng, int math) {return kor<40 || eng<40 || math<40 ? "재시험" : avg>=60 ? "합격" : "불합격"; }
	public static String process_scholar(float avg) {return avg>=95 ? "장학생":"";}
	public static String process_star(float avg) {String result=""; for(int i=0; i<(int)(avg/10);i++) {result += "★";}
		return result;}

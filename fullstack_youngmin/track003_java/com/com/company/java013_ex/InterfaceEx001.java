...
class BoardInsert implements Board {
	@Override public void exec(){System.out.println("글쓰기 기능");}
	}
class BoardSelect implements Board {
	@Override public void exec(){System.out.println("글읽기 기능");}
	}
class BoardUpdate implements Board {
	@Override public void exec(){System.out.println("글수정 기능");}
	}
class BoardDelete implements Board {
	@Override public void exec(){System.out.println("글삭제 기능");}
	}

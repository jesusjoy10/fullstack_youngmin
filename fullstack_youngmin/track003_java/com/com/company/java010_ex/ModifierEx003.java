package com.company.java010_ex;
	...
	// 멤버변수 (private - getters/setters)
	   ...
	   //멤버함수 ( alt + s / 2,3,4 ,getters/setters)
	   //1.생성자 (default / name , kor,eng , math / all arg)
	   //2.상태확인 (toString)
	   //3.getters/setters
	   //4.Score.info(){}   [공용] 클래스메서드 public static 클래스명.매서드명(){}
	   ...
	   public void process_p() {this.p = this.aver<60?"불합격": this.kor<40 || this.eng<40 || this.math<40 ? "재시험": "합격"  ;}
	   public void process_s() {this.s = this.aver<95? "": "장학생";}
	   public void process_rank() {this.rank=""; for(int i= 0; i<(int)(this.aver/10); i++) {this.rank+="★";}}
	   ...
	   @Override
	   public String toString() {return "Score [name=" + name + ", kor=" + kor + ", eng=" + eng + ", math=" + math + ", total=" + total

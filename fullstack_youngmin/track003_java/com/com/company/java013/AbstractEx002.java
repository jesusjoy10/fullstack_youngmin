...
abstract class Astronaut {
    protected String name; //인스턴스 변수 - heap area - this 각각
    protected int stamina; //protected 상속
...
class Engineer extends Astronaut {
    @Override void explore() { System.out.println(this.name + " 엔지니어 탐사: 기계 장치 점검 완료!"); }
...
public class AbstractEx002 {
	 public static void main(String[] args) {
	        // Astronaut astro = new Astronaut();  // Q1. 왜 객체 생성이 불가능한가? {} abstract 메서드가 있어서 . 구현부가 없어서 사용불가능
	        ...
	        for(int i = 0; i<crew.length; i++) {
	        	...
	        	else {System.out.println(crew[i].name+"은체력충분");}
	        } 
	    }
	}

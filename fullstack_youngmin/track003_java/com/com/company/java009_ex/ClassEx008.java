...
class AnimalCharacter {
	...
	void show() {
     ...
     public AnimalCharacter() {super();}     // TODO Auto-generated constructor stub 
	 ...
	 @Override
	 public String toString() {return "AnimalCharacter [name=" + name + ", type=" + type + ", baseSpeed=" + baseSpeed + ", specialBoost="+ specialBoost + ", finalSpeed=" + finalSpeed + "]";}

 ...
 * (static)company         null        (주) 703toyland      x     Toy.name
 * (static)num            x    0          x      0         x      Toy.age
 * --------------------------------------------------------------------
...
class Toy{
	//상태 : 멤버변수
	private String name;  //인스턴스변수 - heap area - new 0 - 생성자 o - this(각각)
	private int    age;   //인스턴스변수 - heap area - new 0 - 생성자 o - this(각각)
 ...
 *1번지 {name="건담", age=47} <- gundam (2번지) 
 *1번지 {name="할로원키티", age=3} <- kitty (1번지) 
 *                    | main   
 * */

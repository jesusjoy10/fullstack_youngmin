...
1.S : (한클래스는 하나만) 한 클래스는 한가지 일만 ( 쿠기 반죽은 쿠기반죽만, 쿠키굽기는 쿠기굽기만) 
2.O : (수정말고 추가만)새로운 쿠기 쉽게 추가 
...
//2.   O: 개방-폐쇠의 원칙 (새로운 쿠키를 추가할 수 있지만, 기존코드 건들지 마세요!)
...
class SimpleCookieMake implements SimpleCookie{
	@Override
	public void make() {System.out.println("쿠키만드는방법은 간단하게.");}
}
...
public class SolidBasic {
	public static void main(String[] args) {
		...
		//2+3  O+L
		System.out.println("2. OL: 개방폐쇄 (레시피추가) + 리스코프(공장 - 어떤쿠키든 굽기가능) 치환");
